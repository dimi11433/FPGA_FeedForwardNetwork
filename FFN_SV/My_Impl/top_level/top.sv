module top#(parameter N = 2)(
    ...
    output logic [15:0] dbg_mac_out  [0:N-1][0:N-1],
    output logic [15:0] dbg_gelu_out [0:N-1][0:N-1],
    output logic [15:0] dbg_mac_out_2[0:N-1][0:N-1],
    output logic        dbg_ready1   [0:N-1][0:N-1],
    output logic        dbg_ready2   [0:N-1][0:N-1]
);
