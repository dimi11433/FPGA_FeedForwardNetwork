...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { led_busy }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
##USB-RS232 Interface
set_property -dict { PACKAGE_PIN C4    IOSTANDARD LVCMOS33 } [get_ports { uart_rxd }]; #IO_L7P_T1_AD6P_35 Sch=uart_txd_in (USB TX → FPGA RX)
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { uart_txd }]; #IO_L11N_T1_SRCC_35 Sch=uart_rxd_out (FPGA TX → USB RX)
