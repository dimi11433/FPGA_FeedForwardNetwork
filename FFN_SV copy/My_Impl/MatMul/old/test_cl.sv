// ============================================================
// fp32_mul.sv — IEEE 754 FP32 Combinational Multiplier
// Handles : normal numbers, zeros
// Flushes : overflow/underflow to zero
// Ignores : inf, NaN, denormals (not needed for FFN weights)
// ============================================================
module fp32_mul (
    input  logic [31:0] a,
    input  logic [31:0] b,
